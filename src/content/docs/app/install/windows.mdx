...
Then look for a folder named `juho05` and delete it.

To remove the cover cache, enter `%localappdata%` into the address bar, look for a folder named `juho05` and delete it aswell.