...
If you are on ArchLinux, you may install Crossonic from the **AUR** instead: [crossonic](https://aur.archlinux.org/packages/crossonic), [crossonic‑bin](https://aur.archlinux.org/packages/crossonic-bin).
...
3. (Optional) Remove all app data:
