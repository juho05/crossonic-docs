...
When you open the file a window with the *Crossonic* icon and the *Applications* directory will appear:
...
8. You'll now be able to open Crossonic any time you like and this procedure should not be needed in the future.
</Steps>
