...
- `Crossonic-x.x.x-android-arm64v8`
  - This should be the correct choice for most phones. If you are unsure try this version first.
- `Crossonic-x.x.x-android-arm32v7`
  - Choose this version if you have an old 32-bit ARM device.
- `Crossonic-x.x.x-android-x64`
  - Choose this version if your device uses the `x86_64` architecture (e.g. some tablets)
...
Now open the downloaded file. You'll be prompted to allow your browser/file manager (depending on which app you used to open the APK file) to install
