...
:::danger
This guide does not cover backing up your music directory. You'll of course also need to create a backup your music directory.
This guide only discussed backing up *crossonic-server specific data*.
:::

## Create a backup

There are two compontents that need to be backed up:
