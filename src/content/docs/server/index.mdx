...
It works by scanning a directory containing your music files and making your music library available to [clients](/server/clients), that can be used to browse
