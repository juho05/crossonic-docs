...
| Name | Description | Examples |
| --- | --- | --- |
| `MUSIC_DIR` | The directory where your music files are stored. **Conflicts:** `MUSIC_DIR_CONFIG` | `/home/user/my_music` |
| `MUSIC_DIR_CONFIG` | Path to the [music dir configuration](/server/configuration/multi-library) file. **Conflicts:** `MUSIC_DIR` | `./config/music_dirs.json` |
