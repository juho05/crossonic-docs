...
To get started visit [this link](https://www.last.fm/api/account/create) and either login to your last.fm account or create a new one. Then you should automatically be
redirected to a page that looks like this (otherwise just click the link again):
...
Now artist images, artist biographies and album info will be automatically fetched from last.fm when a client requests them.