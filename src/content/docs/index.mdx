...
<Card title="Release versions" icon="information">
...
Both the app and the server are fully open source under the MPL-2.0 and AGPL-3.0 license, respectively:
